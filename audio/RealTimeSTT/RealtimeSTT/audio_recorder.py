...
class AudioToTextRecorder:
    ...
    def __init__(self,
        ...
        try:
            self.silero_vad_model, _ = torch.hub.load(
                ...
                #repo_or_dir="/data/fuchengjia/cache/torch/hub/snakers4_silero-vad_master",
                model="silero_vad",
                source='local',
                verbose=False,
            ...
            def validate_device(device_index):
                ...
                try:
                    ...
                    if not device_info.get('maxInputChannels', 0) > 0:
                        ...
                        return False
                    print("target_sample_rate is: ",target_sample_rate)
            ...
            try:
                ...
                if input_device_index is not None:
                    ...
                    if highest_rate != 16000:
                        sample_rates_to_try=[highest_rate]
                else:
    ...
    def text(self,
        ...
        print(f"Transcribe: {duration:.3f}")
        return text
    ...
    def set_enable_transcribe(self, enable_transcribe):
        pass
